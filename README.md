...
```
If you pulled the code from Github, the locations are probably correct and your map should start up with no extra effort, although **you will need to uncomment the location lines before building**.
